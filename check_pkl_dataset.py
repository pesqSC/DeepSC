 ...
 "cells": [
  {
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "First item length: 2\n",
      "\n",
      "SRC ids: [1, 4, 130, 80, 9, 53, 15197, 9, 31, 395, 23, 398, 14368, 8, 1997, 9, 92, 33, 1990, 29]\n",
      "TRG ids: [1, 5, 832, 9, 52, 118, 15197, 9, 15922, 141, 3860, 10, 1569, 3402, 8, 110, 2724, 9, 878, 76]\n",
      "\n",
      "SRC text:\n",
      "<START> <EN> thank you , mr segni , i shall do so gladly . indeed , it is quite in keeping with the positions this house has always adopted . <END>\n",
      "\n",
      "TRG text:\n",
      "<START> <PT> obrigada , senhor deputado segni , fá lo ei de boa vontade . com efeito , essa é a linha das posições que o nosso parlamento sempre adoptou . <END>\n",
      "Missing <EN> at: 0\n",
      "Missing <EN> at: 1\n",
      "Missing <EN> at: 2\n",
      "Missing <EN> at: 3\n",
   ...
   "source": [
    ...
    "\n",
    "PKL_PATH = \"data/train/europarl/train_en_pt.pkl\"\n",
