...
class Receiver(nn.Module):
    ...
    def forward(self, z_noisy: torch.Tensor, trg_inp: torch.Tensor, look_ahead_mask: torch.Tensor, src_mask: torch.Tensor):
        ch_dec_out = self.channel_decoder(z_noisy)
        dec_out = self.decoder(trg_inp, ch_dec_out, look_ahead_mask, src_mask)
